...
interface TableActionBarActionProps
...
interface TableActionBarSelectionProps<TData> {
  table: Table<TData>;
}

function TableActionBarSelection<TData>({
  table,
...
export { TableActionBar, TableActionBarAction, TableActionBarSelection };
