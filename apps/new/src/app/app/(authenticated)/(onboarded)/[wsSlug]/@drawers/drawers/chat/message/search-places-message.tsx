...
import type { GeoapifyPlacesResponse } from "@mapform/backend/data/geoapify/places";
import { FeatureList } from "~/components/feature-list";
import { useParamsContext } from "~/lib/params/client";
import { useWikidataImages } from "~/lib/wikidata-image";

interface SearchPlacesMessageProps {
  result: GeoapifyPlacesResponse | undefined;
}

export function SearchPlacesMessage({ result }: SearchPlacesMessageProps) {
  const map = useMap();
