...
- **FINDING LOCATIONS AND MAPPING**:
  Use findRawInternalFeatures andfindRawExternalFeatures to get structured location data.
...
- **DISPLAYING RESULTS**:
  Always call returnBestResults to display results from findRawInternalFeatures, or findRawExternalFeatures.
...
2. Use tools (findRawExternalFeatures, findRawInternalFeatures) to gather candidate locations.
...
// TODO: Can re-enable this prompt if reverse-geocoding is re-enabled
// export const getSystemPrompt = (
//   mapCenter?: { lat: number; lng: number } | null,
//   userCenter?: { lat: number; lng: number } | null,
//   ipLocation?: Geo | null,
