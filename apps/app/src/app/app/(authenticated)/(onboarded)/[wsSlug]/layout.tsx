...
export default async function WorkspaceLayout(props: {
  ...
  return (
    ...
    >
      ...
      >
        <AppSidebar />
        <main className="prose max-md:ios-momentum max-md:fixed max-md:inset-0 max-md:z-10 max-md:flex max-md:max-w-none max-md:flex-1 max-md:overflow-y-auto max-md:overscroll-contain md:pointer-events-none">
          <AnimatePresence>
            {/* Page-Based Drawers */}
