...
export const InputResponseScalarFieldEnumSchema = z.enum(['id','blockNoteId','title','value','formSubmissionId']);

export const LocationResponseScalarFieldEnumSchema = z.enum(['id','blockNoteId','locationId','formSubmissionId']);
